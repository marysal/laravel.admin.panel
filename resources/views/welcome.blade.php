                ...
                <div class="top-right links">
                    @auth
                        ...
                        @elseif(Auth::user()->isAdministrator())
                            <strong><a href="{{ url("/admin/index") }}" style="color: #0b3e6f; text-decoration: none">Панель администратора</a></strong>
                            <strong><a href="{{ url("/") }}" style="color: #0b3e6f; text-decoration: none">Главная</a></strong>
                        @endif
                    ...
                    @else
                       <strong>
                           <a href="{{ route("login") }}" style="color: #0b3e6f; text-decoration: none">
                               Войти
                           </a>
                       </strong>
                       ...
                       @if(Route::has('register'))
                            <strong>
                                <a href="{{ route("register") }}" style="color: #0b3e6f; text-decoration: none">
                                    Регистрация
                                </a>
                            </strong>
                       @endif
