                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    @forelse($paginator as $order)
                                        @php $class = $order->status == 1 ? 'success' : ''  @endphp
                                        <tr class="{{$class}}">
                                            <td>{{$order->id}}</td>
                                            <td>{{$order->name}}</td>
                                            <td>
                                            ...
                                            <td>
                                                <a href="{{route('blog.admin.orders.edit', $order->id)}}" title="редактировать заказ">
                                                    <i class="fa fa-fw fa-eye"></i>
                                                </a>
                                                <a href="{{route('blog.admin.orders.forcedestroy', $order->id)}}" title="удалить из БД">
